  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        ...
        children: [
          Opacity(opacity: 0.6, child: AppImage.asset("sunny.png", fit: BoxFit.cover))
            .animate(autoPlay: true)
            .rotate(duration: const Duration(seconds: 5), begin: 0, end: 5.0/8.0),
          AppImage.asset("avatar_large.png"),
          Positioned(
            bottom: 200.h,
            child: Text(appService.getTrans("The code is cracked.\nYou are a real detective!"),
              style: TextStyle(color: Colors.white, fontSize: 20.sp, fontWeight: FontWeight.bold, height: 1),
